...
define('dummy/test-engine/tests/addon.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | addon');

  QUnit.test('test-engine/engine.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'test-engine/engine.js should pass ESLint\n\n');
  });

  QUnit.test('test-engine/resolver.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'test-engine/resolver.js should pass ESLint\n\n');
  });

  QUnit.test('test-engine/routes.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'test-engine/routes.js should pass ESLint\n\n');
  });
});
